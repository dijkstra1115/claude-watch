...
Whisper keys are optional. Without one, videos that lack native captions can
still run with frames-only output or explicit --no-whisper.
"""
...
def status_for() -> dict:
    ...
    return {
        ...
        "warnings": [] if has_key else ["missing_whisper_key"],
